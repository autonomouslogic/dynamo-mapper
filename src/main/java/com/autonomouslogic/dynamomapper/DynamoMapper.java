...
public class DynamoMapper {
	...
	protected DynamoMapper(DynamoDbClient client, JsonMapper jsonMapper, TableNameDecorator tableNameDecorator) {
		this.client = client;
	...
	public <T> MappedPutItemResponse<T> putItem(
			...
			throws ConditionalCheckFailedException, ProvisionedThroughputExceededException, ResourceNotFoundException,
					...
					ThrottlingException, AwsServiceException, SdkClientException, DynamoDbException, JacksonException {
