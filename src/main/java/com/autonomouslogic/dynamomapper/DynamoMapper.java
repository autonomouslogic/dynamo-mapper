...
public class DynamoMapper {
	...
	protected DynamoMapper(DynamoDbClient client, JsonMapper jsonMapper,
			TableNameDecorator tableNameDecorator) {
		this.client = client;
	...
	public <T> MappedGetItemResponse<T> getItemFromPrimaryKey(@NonNull Object primaryKey,
			...
			DynamoDbException, JacksonException, IOException {
	...
	@SuppressWarnings("unchecked")
	public <T> MappedGetItemResponse<T> getItemFromKeyObject(@NonNull T keyObject) throws
			ProvisionedThroughputExceededException, ResourceNotFoundException, RequestLimitExceededException,
			InternalServerErrorException, ThrottlingException, AwsServiceException, SdkClientException,
			DynamoDbException, JacksonException, IOException {
		var builder = requestFactory.getItemRequestFromKeyObject(keyObject);
	...
	public <T> MappedBatchGetItemResponse<T> batchGetItemFromPrimaryKeys(@NonNull List<?> primaryKey,
			@NonNull Class<T> clazz) throws ProvisionedThroughputExceededException,
			ResourceNotFoundException, RequestLimitExceededException, InternalServerErrorException,
			ThrottlingException, AwsServiceException, SdkClientException, DynamoDbException,
			JacksonException, IOException {
	...
	@SuppressWarnings("unchecked")
	public <T> MappedBatchGetItemResponse<T> batchGetItemFromKeyObjects(@NonNull List<T> keyObject,
			@NonNull Class<T> clazz) throws ProvisionedThroughputExceededException,
			ResourceNotFoundException, RequestLimitExceededException, InternalServerErrorException,
			ThrottlingException, AwsServiceException, SdkClientException, DynamoDbException,
			JacksonException, IOException {
	...
	public <T> MappedBatchGetItemResponse<T> batchGetItem(
			@NonNull Consumer<BatchGetItemRequest.Builder> consumer, @NonNull Class<T> clazz) throws
			ProvisionedThroughputExceededException, ResourceNotFoundException, RequestLimitExceededException,
			InternalServerErrorException, ThrottlingException, AwsServiceException, SdkClientException,
			DynamoDbException, JacksonException {
	...
	@SuppressWarnings("unchecked")
	public <T> MappedBatchGetItemResponse<T> batchGetItemFromKeyObjects(@NonNull List<T> keyObject,
			@NonNull Class<T> clazz, @NonNull Consumer<BatchGetItemRequest.Builder> consumer) throws
			ProvisionedThroughputExceededException, ResourceNotFoundException, RequestLimitExceededException,
			InternalServerErrorException, ThrottlingException, AwsServiceException, SdkClientException,
			DynamoDbException, JacksonException, IOException {
		var builder = requestFactory.batchGetItemRequestFromKeyObjects(keyObject);
	...
	public <T> MappedPutItemResponse<T> putItemFromKeyObject(@NonNull T keyObject) throws
			...
			ReplicatedWriteConflictException, ThrottlingException, AwsServiceException, SdkClientException,
			DynamoDbException, JacksonException, IOException {
		var builder = requestFactory.putItemRequestFromKeyObject(keyObject);
		return putItem(builder.build(), (Class<T>) keyObject.getClass());
	}
	...
	public <T> MappedUpdateItemResponse<T> updateItem(
			@NonNull Consumer<UpdateItemRequest.Builder> consumer, @NonNull Class<T> clazz) throws
			ConditionalCheckFailedException, ProvisionedThroughputExceededException,
			ResourceNotFoundException, ItemCollectionSizeLimitExceededException,
			TransactionConflictException, RequestLimitExceededException, InternalServerErrorException,
			ReplicatedWriteConflictException, ThrottlingException, AwsServiceException, SdkClientException,
	...
	public <T> MappedUpdateItemResponse<T> updateItemFromKeyObject(@NonNull T keyObject,
			@NonNull Consumer<UpdateItemRequest.Builder> consumer) throws ConditionalCheckFailedException,
			ProvisionedThroughputExceededException, ResourceNotFoundException,
			ItemCollectionSizeLimitExceededException, TransactionConflictException,
			RequestLimitExceededException, InternalServerErrorException, ReplicatedWriteConflictException,
			ThrottlingException, AwsServiceException, SdkClientException, DynamoDbException,
	...
	public <T> MappedUpdateItemResponse<T> updateItem(@NonNull UpdateItemRequest request,
			@NonNull Class<T> clazz) throws ConditionalCheckFailedException,
			ProvisionedThroughputExceededException, ResourceNotFoundException,
			ItemCollectionSizeLimitExceededException, TransactionConflictException,
			RequestLimitExceededException, InternalServerErrorException, ReplicatedWriteConflictException,
	...
	@SuppressWarnings("unchecked")
	public <T> MappedUpdateItemResponse<T> updateItemFromKeyObject(@NonNull T keyObject) throws
			ConditionalCheckFailedException, ProvisionedThroughputExceededException,
			ResourceNotFoundException, ItemCollectionSizeLimitExceededException,
			TransactionConflictException, RequestLimitExceededException, InternalServerErrorException,
			ReplicatedWriteConflictException, ThrottlingException, AwsServiceException, SdkClientException,
	...
	public <T> MappedDeleteItemResponse<T> deleteItemFromPrimaryKey(@NonNull Object primaryKey,
			@NonNull Consumer<DeleteItemRequest.Builder> consumer, @NonNull Class<T> clazz) throws
			ConditionalCheckFailedException, ProvisionedThroughputExceededException,
			ResourceNotFoundException, ItemCollectionSizeLimitExceededException,
			TransactionConflictException, RequestLimitExceededException, InternalServerErrorException,
	...
	@SuppressWarnings("unchecked")
	public <T> MappedDeleteItemResponse<T> deleteItemFromKeyObject(@NonNull T keyObject) throws
			ConditionalCheckFailedException, ProvisionedThroughputExceededException,
			ResourceNotFoundException, ItemCollectionSizeLimitExceededException,
			TransactionConflictException, RequestLimitExceededException, InternalServerErrorException,
			ReplicatedWriteConflictException, ThrottlingException, AwsServiceException, SdkClientException,
	...
	public <T> MappedScanResponse<T> scan(@NonNull Consumer<ScanRequest.Builder> consumer,
			@NonNull Class<T> clazz) throws ProvisionedThroughputExceededException,
			ResourceNotFoundException, RequestLimitExceededException, InternalServerErrorException,
			ThrottlingException, AwsServiceException, SdkClientException, DynamoDbException,
			JacksonException {
	...
	public <T> MappedScanResponse<T> scan(@NonNull ScanRequest request, @NonNull Class<T> clazz) throws
			ProvisionedThroughputExceededException, ResourceNotFoundException, RequestLimitExceededException,
			InternalServerErrorException, ThrottlingException, AwsServiceException, SdkClientException,
			DynamoDbException, JacksonException {
	...
	public <T> MappedQueryResponse<T> query(@NonNull Consumer<QueryRequest.Builder> consumer,
			@NonNull Class<T> clazz) throws ProvisionedThroughputExceededException,
			ResourceNotFoundException, RequestLimitExceededException, InternalServerErrorException,
			ThrottlingException, AwsServiceException, SdkClientException, DynamoDbException,
			JacksonException {
	...
	public <T> MappedQueryResponse<T> query(@NonNull QueryRequest request, @NonNull Class<T> clazz)
			...
			RequestLimitExceededException, InternalServerErrorException, ThrottlingException,
			AwsServiceException, SdkClientException, DynamoDbException, JacksonException {
